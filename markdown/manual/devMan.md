...
3D都市モデル（3DTiles） は、[G空間センター](https://front.geospatial.jp/)からダウンロードしてください。
建築物モデル等のSTLへの変換および植生モデル（LOD1,2）のCityGML、3DTilesおよびSTLは、本リポジトリのFMEワークスペースで作成することが可能です。
