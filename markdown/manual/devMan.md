...
本書では、温熱環境シミュレーション機能の利用環境構築手順について記載しています。PLATEAUの3D都市モデルおよび樹木データを活用し、対象エリアの温熱環境のシミュレーションを行う機能を提供します。
...
| オープンソースソフトウェア | [OpenFOAM](https://www.openfoam.com/) | - | オープンソースの数値流体計算（CFD）ソフトウェア |
...
シミュレーション計算サーバ（Linux 64bit）に [OpenFOAM](https://www.openfoam.com/news/main-news/openfoam-v2506) をインストールします。インストール手順は公式サイトを参照してください。
...
3D都市モデル（3DTilesおよびSTL、建築物モデル・植生モデル等）を Amazon S3 に格納します。対象は、技術検証レポートにてご確認ください。
3D都市モデル（3DTiles） は、[G空間センター](https://front.geospatial.jp/)からダウンロードしてください。建築物モデル等のSTLへの変換および植生モデル（LOD1,2）のCityGML、3DTilesおよびSTLは、本リポジトリの[FMEワークスペース](https://github.com/Project-PLATEAU/green-thermal-simulation/tree/main/workspaces)で作成することが可能です。
